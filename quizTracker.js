class QuizTracker {
    ...
    document.getElementById('results').innerHTML = `
        <div id="tableWrapper">
            <table>
                <tr><th colspan="2" class="embossed">Quiz Results</th></tr>
                ...
                <tr><th colspan="2" class="embossed">Total Marks</th></tr>
                <tr><td colspan="2">${total_marks}/${max_marks}</td></tr>
                <tr><td colspan="2">${percentage.toFixed(2)}%</td></tr>
                <tr><th colspan="2" class="embossed">If None Were Incorrect</th></tr>
